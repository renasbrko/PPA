...
const translations = {
  ar: {
    ...
    about_p3: " نوفّر محتوى دراسيًا قويًا، مبسطًا، وموثوقًا يشمل الشروحات، الملازم، والأسئلة الوزارية — مجانًا، لأننا نؤمن أن العلم حق للجميع، لا امتياز للبعض. نخلق تجربة تعليمية تفاعلية حقيقية، نكون فيها قريبين من الطالب، نفهمه، وندعمه خطوة بخطوة. ونعمل بكل فخر على تعزيز هويتنا وثقافتنا الكوردية، لنصنع جيلًا لا يحمل العلم فقط، بل يحمل رسالته أيضًا.",
    about_quote: "«خير الناس أنفعهم للناس»",
    about_p4: "نيدًا بيد مع المعلمين والمنظمات، نعمل لنضمن أن لا يُحرم أي طالب من فرصة التعلم، لأننا نؤمن أن كل طالب قادر… إذا وجد من يؤمن به.",
    // Footer
  ...
  ku: {
    ...
    // About
    sec_about: "ديدگای ئێمه",
    about_title: "پلاتفۆرمی پەروەردەیی ئەلند",
    about_p1: "ئامانج ئەوەیە کە پلاتفۆرمی ئەلند ئەو پریشکە بێت کە ڕێنێسانسێکی پەروەردەیی ڕاستەقینە لە کۆمەڵگەی کوردیدا هەڵدەگیرسێنێت، و ببێتە شوێنی یەکەمی بێ مشتومڕ بۆ هەر خوێندکارێک کە بەدوای باشی و زانستدا دەگەڕێت.",
    about_p2: "ئێمە هەوڵ دەدەین بۆ بنیاتنانی نەوەیەکی بەهێز و هۆشیار و داهێنەر کە نەک هەر فێربێت بەڵکو سەرکردایەتی گۆڕانکاری بکات و کۆمەڵگاکەی بەرز بکاتەوە بۆ ئەوەی لەنێو گەورەترین گەلانی جیهاندا بوەستێت.",
    about_p3: "ئێمە ناوەڕۆکی پەروەردەیی بەهێز و سادە و جێی متمانە پێشکەش دەکەین، لەوانەش ڕوونکردنەوە، ڕێنمایی خوێندن و پرسیارەکانی تاقیکردنەوەی وەزاری ڕابردوو- هەموو ئەمانە بێ بەرامبەر، چونکە ئێمە پێمان وایە کە پەروەردە مافێکە بۆ هەموو کەسێک، نەک ئیمتیازێک بۆ چەند کەسێکی هەڵبژێردراو. ئێمە ئەزموونێکی فێرکاری بەڕاستی کارلێککارانە دروست دەکەین، کە تێیدا لە خوێندکارەوە نزیک دەبینەوە، لێی تێدەگەین و لە هەموو هەنگاوێکی ڕێگاکەدا پشتگیریان دەکەین. ئێمە بە شانازییەوە کاردەکەین بۆ بەهێزکردنی ناسنامە و کولتووری کوردمان، بۆ چاندنی نەوەیەک کە نەک هەر خاوەنی مەعریفە بەڵکو هەڵگری پەیامەکەی بێت.",
    about_quote: "«باشترین مرۆڤ ئەوەیە کە زیاتر سوودی بۆ خەڵکی هەیە»",
    about_p4: "دەست بە دەست لەگەڵ مامۆستایان و ڕێکخراوەکان، کاردەکەین بۆ ئەوەی هیچ خوێندکارێک دەرفەتی فێربوون لێ وەرنەگیرێت، چونکە ئێمە پێمان وایە هەموو خوێندکارێک بەتوانایە... ئەگەر کەسێک باوەڕیان پێی هەبێت.",
    // Footer
...
const LangManager = {
  ...
  set(lang) {
    this.current = lang;
    localStorage.setItem('PPAland_lang', lang);
    this.apply();
  },
